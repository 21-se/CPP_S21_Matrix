...
Библиотека s21_matrix_oop для обработки числовых матриц с использованием объектно-ориентированного программирования.

## [](https://platform.21-school.ru/project/26485/task#information)Information

### [](https://platform.21-school.ru/project/26485/task#c-и-c)C++ и C
...
### [](https://platform.21-school.ru/project/26485/task#пример-класса-матрицы-на-c)Пример класса матрицы на C++

`class S21Matrix {     private:         // Attributes         int rows_, cols_;         // Rows and columns         double **matrix_;         // Pointer to the memory where the matrix is allocated     public:         S21Matrix();              // Default constructor         ~S21Matrix();             // Destructor         void SumMatrix(const S21Matrix& other);          // Other methods.. }`

### [](https://platform.21-school.ru/project/26485/task#напоминание-основных-положений-о-матрице)Напоминание основных положений о матрице
...
### [](https://platform.21-school.ru/project/26485/task#операции-над-матрицами)Операции над матрицами
